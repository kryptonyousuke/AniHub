...
function Manga(){
    ...
    const [pages, setPages] = useState(["image.png", "image.png", "image.png", "image.png", "image.png", "image.png", "image.png", "image.png", ]);
    ...
    return <div className={styles.manga}>
        ...
        <section className={styles.mangaPages}>
            {
                pages.map((x) => <img src={x} className={styles.mangaPage} onClick={ () => { navigate("/mangareader") } }></img>)
            }
        </section>
    </div>
}
